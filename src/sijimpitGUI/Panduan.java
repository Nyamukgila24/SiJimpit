...
public class Panduan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Di tab ini berisikan panduan ");

        jLabel3.setText("penggunaan aplikasi SiJimpit ");

        jLabel4.setText("Mulai dari Login hingga pembayaran ");

        jLabel5.setText("User juga dapat melihat pembayaran melalui");

        jLabel6.setText("mutasi pembayaran user dapat mengunduh mutasi ");

        jLabel7.setText("sebagai bukti bahwa user telah membayar iuran");
